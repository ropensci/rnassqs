...
To use the NASS Quick Stats API you need an [API key](http://quickstats.nass.usda.gov/api). There are several ways of setting your API key. You can set the variable explicitly and pass it to functions, like so
